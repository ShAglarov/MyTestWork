...
//    private func postRequestGetRefresh<T: Codable>(json: [String: Any], responseModel: T.Type) async throws -> T {
...
//        case 200...299:
//            if let jsonResult = try JSONSerialization.jsonObject(with: data, options: []) as? T {
//                return jsonResult
//            } else {
...
//    func getToken(refresh: String) async throws -> AuthResponse {
//        let requestBody: [String : Any] = [
//            "refresh" : refresh
//        ]
//        return try await postRequestGetRefresh(json: requestBody, responseModel: AuthResponse.self)
//    }
